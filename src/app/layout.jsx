        ...
        <html lang="en">
            <head>
                ...
                <script type="text/partytown" dangerouslySetInnerHTML={{
                    __html: "!function(e,t,a,n,g){e[n]=e[n]||[],e[n].push({'gtm.start':(new Date).getTime(),event:'gtm.js'});var m=t.getElementsByTagName(a)[0],r=t.createElement(a);r.async=!0,r.src='https://www.googletagmanager.com/gtm.js?id=GTM-TZNHH5M7',m.parentNode.insertBefore(r,m)}(window,document,'script','dataLayer');"
                }} />
                {/* <!-- Google Tag Manager --> */}
