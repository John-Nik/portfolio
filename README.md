...
**2.0.1:** Updated the favicon to a more modern-looking one, and fixed a bug in the minesweeper game

**2.0.2:** Update download link from `rx-resume.john-nik.com` to `resume.john-nik.com`